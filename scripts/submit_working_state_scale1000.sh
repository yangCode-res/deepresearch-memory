...
RUN_DIR="${RUN_DIR:-${ROOT}/data/working-state-labels/scale1000}"
...
sbatch --parsable \
  --array="0-31%4" \
  --export="ALL,PROJECT_ROOT=${ROOT},RUN_DIR=${RUN_DIR},EXCLUDE_QIDS_FILE=${EXCLUDE_QIDS_FILE},NUM_SHARDS=32,TARGET_TRAJECTORIES_PER_SHARD=25,DATA_MODEL=mimo-v2.5-pro" \
